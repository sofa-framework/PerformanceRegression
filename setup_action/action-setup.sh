...
cmake $SOURCE_DIR -GNinja -DCMAKE_BUILD_TYPE=Release \
                  ...
                  -DSOFA_TRACY=ON \
                  -DSOFA_BUILD_TESTS=OFF -DPLUGIN_SOFA_GUI_QT=OFF -DLIBRARY_SOFA_GL=ON \
                  -DSOFA_FETCH_SOFAGLFW=OFF -DPLUGIN_MULTITHRADING=ON \
                  -DSOFA_FETCH_CSPARSESOLVERS=ON -DSOFA_FETCH_SOFA.METIS=ON \
